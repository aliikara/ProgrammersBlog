...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class OptionsController : Controller
    {
        ...
        public OptionsController(IOptionsSnapshot<AboutUsPageInfo> aboutUsPageInfo, IWritableOptions<AboutUsPageInfo> aboutUsPageInfoWriter,
            IToastNotification toastNotification, IOptions<WebsiteInfo> websiteInfo, IWritableOptions<WebsiteInfo> websiteInfoWriter,
            IOptionsSnapshot<SmtpSettings> smtpSettings, IWritableOptions<SmtpSettings> smtpSettingsWriter,
            IOptions<ArticleRightSideBarWidgetOptions> articleRightSideBarWidgetOptions,
